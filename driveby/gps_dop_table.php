  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      function drawTable() {
         ...
         data.addColumn('number', 'Xdop');
         data.addColumn('number', 'Ydop');
         data.addColumn('number', 'Vdop');
         data.addColumn('number', 'Tdop');
         data.addColumn('number', 'Hdop');
         data.addColumn('number', 'Gdop');
         data.addColumn('number', 'Pdop');
         data.addRow([0,0,0,0,0,0,0]);
      ...
      function updateRow(newDataRowArr) {
         if (typeof newDataRowArr === 'undefined') {
            ...
            data.setValue(0, 5, newDataRowArr[5]);
            data.setValue(0, 6, newDataRowArr[6]);
      }

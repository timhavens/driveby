   ...
   <body style="font-family:Arial;background-color:grey;">
      <table style="width:100%; height:100%;">
         <tr style="width:100%; height:500px;">
            <td style="width:50%; height:100%;background-color:white;"><iframe frameBorder="0" src="/driveby_new/system_status.php" style="width:100%; height:250px"></iframe></td>
            <td style="width:50%; height:100%;"><iframe frameBorder="0" src="/driveby_new/gps.php" style="width:100%; height:250px"></iframe></td>
         </tr>
         <tr colspan=2 style="width:100%; height:500px;">
            <td style="width:50%; height:100%;"><iframe frameBorder="0" src="/driveby_new/control.php" style="width:100%; height:500px"></iframe></td>
            <td style="width:50%; height:100%;"><iframe frameBorder="0" src="/driveby_new/nf.php" style="width:100%; height:500px"></iframe></td>
         </tr>
      </table>
   </body>
</html>